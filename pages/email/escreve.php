  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="email.php"></i> Caixa de Email</a></li>
        <li class="active">Novo Email</li>
      </ol>
    </section>
...
<section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="email.php" class="btn btn-primary btn-block margin-bottom">Caixa de Entrada</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="fa fa-envelope-o"></i> Enviado</a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> Rascunho</a></li>
                <li><a href="#"><i class="fa fa-filter"></i> Marcados <span class="label label-warning pull-right">65</span></a>
                </li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Escrever Nova Messagem</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Arquivar</button>
