            ...
            <div role="tabpanel" class="tab-pane active" id="dados_pessoais">
              <div style="padding-top:10px;">
                <form action="" method="POST">
                  ...
                  <!--nome-->
                  <div class="row">
                    <h4 class="col-md-4">Nome completo</h4>
                  </div>
                  <div class="form-group row">
                    <label class="col-md-1">Nome:</label>  
                      <div class="col-md-5">
                        <input type="text" name="pri_nome" placeholder="Primeiro Nome" class="form-control input-md" required autofocus />
                      </div>
                    <label class="col-md-1">Sobrenome:</label>  
                      <div class="col-md-5">
                        <input type="text" name="sec_nome" placeholder="Segundo Nome" class="form-control input-md" required/>
                      </div>  
                  </div>
                  <!--filiação-->
                  <div class="row">
                    <h4 class="col-md-4">Filiação</h4>
                  </div>
                  <div class="form-group row">
                    <label class="col-md-1">Nome do Pai:</label>  
                      <div class="col-md-11">
                        <input type="text" name="nome_pai" placeholder="Nome" class="form-control input-md" required/><br>
                      </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-md-1">Nome da Mãe:</label>  
                      <div class="col-md-11">
                        <input type="text" name="nome_mae" placeholder="Nome" class="form-control input-md" required/><br>
                      </div>
                  </div>
                  <!--documentos-->
                  <div class="row">
                  ...
                  <div class="form-group row">
                    <label class="col-md-1">CPF:</label>  
                    <div class="col-md-2">
                  ...
                  <div class="form-group row">
                    <form action="" method="POST">
                      ...
                      <div class="col-md-6">
                        <input name="cep" type="text" maxlength="8" pattern="[0-9]+$"/>
                        <button type="submit" class="btn-flat btn-success" name="busca">Buscar</button>  
                      </div>
                    </form>
                  </div>
                  <div class="form-group row">  
                    ...
                    <div class="col-md-5">
                      <input name="rua" class="form-control" required type="text"/>
                    </div>
                  ...
                  <div class="form-group row">
                    <label class="col-md-1">Bairro:</label>
                      <div class="col-md-2">
                        <input name="bairro" class="form-control" required type="text"/>
                      </div>    
                    
                    <label class="col-md-1">Cidade:</label>
                      <div class="col-md-2">
                        <input name="cidade" class="form-control" required type="text"/>
                      </div>
                  
                    <label class="col-md-1">Estado:</label>
                      <div class="col-md-2">
                        <input name="estado" class="form-control" required type="text"/>
                      </div>
                  </div>
